    ...
    private void jsonParse() {
        ...
        JsonObjectRequest request4 = new JsonObjectRequest(Request.Method.GET, url4, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ArrayList<String> subclassSpinnerArrayList = new ArrayList<String>();
                            subclassSpinnerArrayList.add("None");
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                subclassSpinnerArrayList.add(firstname);

                            }
                            Spinner subclassSpinner = (Spinner) findViewById(R.id.subclass_spinner);

                            ArrayAdapter<String> adapter =
                                    new ArrayAdapter<String>(getApplicationContext(),  android.R.layout.simple_spinner_dropdown_item, subclassSpinnerArrayList);
                            adapter.setDropDownViewResource( android.R.layout.simple_spinner_dropdown_item);
